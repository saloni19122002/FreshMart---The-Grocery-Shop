    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1 space-y-6">
          <a href={`mailto:${general.contactEmail}`} className="card p-6 flex items-start gap-4 hover:border-primary-200 hover:shadow-md transition-all group block">
            ...
            <div>
              ...
              <span className="text-primary-600 font-medium">{general.contactEmail}</span>
            </div>
          </a>

          <a href={`tel:${general.supportPhone}`} className="card p-6 flex items-start gap-4 hover:border-primary-200 hover:shadow-md transition-all group block">
            <div className="w-12 h-12 rounded-full bg-primary-50 text-primary-600 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <Phone size={24} />
            </div>
            <div>
              ...
              <span className="text-primary-600 font-medium">{general.supportPhone}</span>
            </div>
          </a>

          <div className="card p-6 flex items-start gap-4 hover:border-primary-200 hover:shadow-md transition-all group block">
            <div className="w-12 h-12 rounded-full bg-primary-50 text-primary-600 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <MapPin size={24} />
            </div>
            <div>
              ...
              <span className="text-primary-600 font-medium">{general.address || '123 Fresh Valley Road, Green District'}</span>
            </div>
          </div>
        </div>
