  ...
  return (
    <div className="w-full max-w-md mx-auto animate-in fade-in zoom-in-95 duration-500 py-2 relative min-h-[600px] flex flex-col justify-center">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Welcome to FreshMart</p>
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <input 
                type="password" 
                {...register('password')} 
                className={`w-full bg-slate-50 border-2 border-transparent rounded-2xl py-3 px-5 focus:bg-white focus:border-emerald-500/20 focus:ring-4 focus:ring-emerald-500/5 transition-all font-bold text-slate-900 text-sm ${errors.password ? 'border-red-100 bg-red-50/30' : ''}`} 
